...
class BaseLanguageClient {
    ...
    resolveDocumentSelector(options, method) {
            ...
            if (this._clientOptions.documentSelector || this._clientOptions.documentSelectorFactory) {
                ...
                if (textDocumentSyncOptions) {
                    ...
                    if (textDocumentSyncOptions.openClose) {
                        registeredHandlers.get(protocol_1.DidOpenTextDocumentNotification.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DidOpenTextDocumentNotification.type.method) }
                        });
                        registeredHandlers.get(protocol_1.DidCloseTextDocumentNotification.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DidCloseTextDocumentNotification.type.method) }
                        });
                    }
                    if (textDocumentSyncOptions.change !== protocol_1.TextDocumentSyncKind.None) {
                        registeredHandlers.get(protocol_1.DidChangeTextDocumentNotification.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DidChangeTextDocumentNotification.type.method) }, { syncKind: textDocumentSyncOptions.change })
                        });
                    }
                    if (textDocumentSyncOptions.willSave) {
                        registeredHandlers.get(protocol_1.WillSaveTextDocumentNotification.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.WillSaveTextDocumentNotification.type.method) }
                        });
                    }
                    if (textDocumentSyncOptions.willSaveWaitUntil) {
                        registeredHandlers.get(protocol_1.WillSaveTextDocumentWaitUntilRequest.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.WillSaveTextDocumentWaitUntilRequest.type.method) }
                        });
                    }
                    if (textDocumentSyncOptions.save) {
                        registeredHandlers.get(protocol_1.DidSaveTextDocumentNotification.type.method).register({
                            id: UUID.generateUuid(),
                            registerOptions: Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DidSaveTextDocumentNotification.type.method) }, { includeText: !!textDocumentSyncOptions.save.includeText })
                        });
                    }
                }
            }
    ...
    hookCapabilities(_connection) {
        ...
        if (this._capabilites.completionProvider) {
            let options = Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.CompletionRequest.type.method) }, this._capabilites.completionProvider);
        ...
        if (this._capabilites.hoverProvider) {
            registeredHandlers.get(protocol_1.HoverRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.HoverRequest.type.method) }
            });
        }
        if (this._capabilites.signatureHelpProvider) {
            let options = Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.SignatureHelpRequest.type.method) }, this._capabilites.signatureHelpProvider);
        ...
        if (this._capabilites.definitionProvider) {
            registeredHandlers.get(protocol_1.DefinitionRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DefinitionRequest.type.method) }
            });
        }
        if (this._capabilites.referencesProvider) {
            registeredHandlers.get(protocol_1.ReferencesRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.ReferencesRequest.type.method) }
            });
        }
        if (this._capabilites.documentHighlightProvider) {
            registeredHandlers.get(protocol_1.DocumentHighlightRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentHighlightRequest.type.method) }
            });
        }
        if (this._capabilites.documentSymbolProvider) {
            registeredHandlers.get(protocol_1.DocumentSymbolRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentSymbolRequest.type.method) }
            });
        }
        if (this._capabilites.workspaceSymbolProvider) {
            registeredHandlers.get(protocol_1.WorkspaceSymbolRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.WorkspaceSymbolRequest.type.method) }
            });
        }
        if (this._capabilites.codeActionProvider) {
            registeredHandlers.get(protocol_1.CodeActionRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.CodeActionRequest.type.method) }
            });
        }
        if (this._capabilites.codeLensProvider) {
            let options = Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.CodeLensRequest.type.method) }, this._capabilites.codeLensProvider);
        ...
        if (this._capabilites.documentFormattingProvider) {
            registeredHandlers.get(protocol_1.DocumentFormattingRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentFormattingRequest.type.method) }
            });
        }
        if (this._capabilites.documentRangeFormattingProvider) {
            registeredHandlers.get(protocol_1.DocumentRangeFormattingRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentRangeFormattingRequest.type.method) }
            });
        }
        if (this._capabilites.documentOnTypeFormattingProvider) {
            let options = Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentOnTypeFormattingRequest.type.method) }, this._capabilites.documentOnTypeFormattingProvider);
        ...
        if (this._capabilites.renameProvider) {
            registeredHandlers.get(protocol_1.RenameRequest.type.method).register({
                id: UUID.generateUuid(),
                registerOptions: { documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.RenameRequest.type.method) }
            });
        }
        if (this._capabilites.documentLinkProvider) {
            let options = Object.assign({ documentSelector: this.resolveDocumentSelector(this._clientOptions, protocol_1.DocumentLinkRequest.type.method) }, this._capabilites.documentLinkProvider);
