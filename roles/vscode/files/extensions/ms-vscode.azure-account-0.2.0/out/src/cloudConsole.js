    ...
    return () => {
        return (function retry() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const inProgress = delayed(() => vscode_1.window.showInformationMessage(localize('azure-account.provisioningInProgress', "Provisioning a Cloud Shell may take a few seconds.")), 2000);
                try {
